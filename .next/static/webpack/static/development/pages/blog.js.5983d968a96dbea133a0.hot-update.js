...
function Blog(props) {
  ...
  return __jsx(_components_Layout__WEBPACK_IMPORTED_MODULE_2__["default"], null, __jsx("h1", null, "This is the blog page"), __jsx("h2", null, "By using custom server route listening"), __jsx("ul", null, props.posts.map(function (ps) {
    ...
    }), __jsx(Card.Body, null, __jsx(Card.Title, null, "Card Title"), __jsx(Card.Text, null, "Some quick example text to build on the card title and make up the bulk of the card's content."), __jsx(Button, {
      variant: "primary"
    }, "Go somewhere"))));
  })));
}
...
//# sourceMappingURL=blog.js.5983d968a96dbea133a0.hot-update.js.map