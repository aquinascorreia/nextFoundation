...
var Index = function Index(props) {
  ...
  })), __jsx("h1", null, "By using custom server route listening"), __jsx("ul", null, props.posts.map(function (ps) {
    return __jsx("li", {
      key: ps.id
    }, __jsx(next_link__WEBPACK_IMPORTED_MODULE_3___default.a, {
      as: "/post?UniqueMessageId=".concat(ps.UniqueMessageId),
      href: "/post?UniqueMessageId=".concat(ps.UniqueMessageId)
    }, __jsx("a", {
      style: {
        'fontSize': '20px'
      }
  ...
  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 17:
          posts = _context.sent;
          console.log(posts.data); //console.log(data.docs);
...
//# sourceMappingURL=index.js.96dc4ceeb84cdb4a7cba.hot-update.js.map