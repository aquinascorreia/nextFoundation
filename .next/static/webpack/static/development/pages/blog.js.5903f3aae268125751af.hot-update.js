...
function Blog(props) {
  ...
  return __jsx(_components_Layout__WEBPACK_IMPORTED_MODULE_2__["default"], null, __jsx("h1", null, "This is the blog page"), __jsx("h2", null, "By using custom server route listening"), __jsx("ul", null, props.posts.map(function (ps) {
    ...
    }), __jsx(Card.Body, null, __jsx(Card.Title, null, "Card Title"), __jsx(Card.Text, null, ps.caption), __jsx(react_bootstrap_Button__WEBPACK_IMPORTED_MODULE_4__["default"], {
      variant: "primary"
    }, "Go somewhere"))));
  })));
}
...
//# sourceMappingURL=blog.js.5903f3aae268125751af.hot-update.js.map